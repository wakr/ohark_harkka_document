...
\paragraph{3-taso}
Vastuut ovat siinä jaettu niin, että näkymistä huolehtivat HTML-tiedostot, sovellustasosta huolehtivat mallit sekä kontrollerit, jotka saavat pyyntöjä UI:lta 
(HTML/HTTP). Datataso Railsissä koostuu ActiveDirectorystä, tietokannasta sekä varsinkin malleista. Mallit siis kuuluvat periaatteessa sovellustason sekä datatason välimaastoon, koska toisaalta kaikki sovelluslogiikka sijaitsee niissä, mutta toisaalta ne toimivat abstraktiona tietokannan tauluille ja koko tietokannan muokkaus tapahtuu suoraan mallien kautta.
