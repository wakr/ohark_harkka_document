...
Kehyksen huonot puolet tulevat suurimmalta osin konventioiden pakollisuudesta sekä Ruby-kielestä.
...
Rails-kehys vaatii paljon esiasennusta, koska esimerkiksi tavallisissa Linux-jakeluissa ei edes ole Ruby-kirjastoa valmiina. Tämän päälle pitää asentaa itse kehys ja se vie suhteellisen paljon enemmän tilaa ja aikaa, kuin muut paljon kevyemmät kehykset. Tästä johtuu suhteellisen huono palvelimien tuki Ruby on Rails-kehykselle ja aikaa saa kulumaan palvelimen säätämisessä Railsia varten. 
...
Miksi kuitenkin suurinosa startup-yrityksistä käyttää kehystä?
http://www.nascenia.com/why-startups-use-ruby-on-rails/
