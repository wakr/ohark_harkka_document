...
Etsivät järjestelmän rajoja: esim, kuormitusmuutoksia, alustan
vaihto, palvelimen rikkoutuminen
...
\caption{Skenaariot sijaitsevat oikealla ja jokainen on arvioitu niin, että ensimmäisenä on suluissa skenaarion vaativuus ja sen jälkeen työmäärä.}
\end{center}
\end{figure}
